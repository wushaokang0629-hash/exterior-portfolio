...
export default function Portfolio() {
  ...
  return <GlowCursor className="portfolio-cursor" color="#7C3AED" secondaryColor="#A78BFA" trailLength={40} trailWidth={8} trailTaper={0.8} followSpeed={0.16} glowIntensity={1.9} glowSpread={1.2} hotspot={0.65} brightness={1.25} opacity={1} pulseSpeed={1.1} noiseStrength={0.035} idleFade idleTimeout={700} fadeDuration={900} blendMode="screen"><div className="portfolio-shell">
    {route==='/' && <div className="aurora-background" aria-hidden="true"><Aurora colorStops={['#7cff67','#B497CF','#5227FF']} blend={0.5} amplitude={1.0} speed={0.5}/></div>}
    ...
    {route==='/' ? <main className="home-content"><p className="eyebrow">ARCHITECTURAL VISUALIZATION</p><h1>空间之外<span>想象之内。</span></h1><a className="enter-link" href="#/works">浏览作品 <span>↗</span></a><footer><span>室外建筑 · 视觉作品集</span><span>PORTFOLIO / 01</span></footer></main>
